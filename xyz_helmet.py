...
class helmet():
    ...
    def callback_helmet(self,data):
        ...
        if data.transform:
            ...
            self.roll = self.euler[0]*180/pi
            self.pitch = self.euler[1]*180/pi
            self.yaw = self.euler[2]*180/pi
            # print (self.yaw)
    ...
    def talker(self):
        ...
        rospy.Subscriber("vicon/helmet/helmet", TransformStamped, self.callback_helmet) #where the information is coming from, type, information
